    ...
    <>
      <div data-theme="cyberpunk" className="p-4">
        <div className="flex flex-col justify-start text-left">
          ...
          <p>Here I place apps from <Link className="link link-neutral" to="https://github.com/florinpop17/app-ideas" target="_blank">App Ideas</Link> which I&apos;ve found in Redux tutorial.</p>
